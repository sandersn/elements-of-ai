...
expand (Num i:pattern) n = []
expand (Star:[]) n = [[White | _ <- [0..n - 1]]]
expand (Star:pattern) n = [[]] -- TODO: Write expansion for Plus and Star
expand (Plus:pattern) 0 = []
expand (Plus:[]) n = [[White | _ <- [0..n - 1]]]
expand (Plus:pattern) n = [[White]] -- TODO: Write expansion for Plus and Star
